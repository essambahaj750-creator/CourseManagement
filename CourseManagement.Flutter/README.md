...
يغطي الاختبار الحالي نماذج الجلسة، انتهاء JWT، عقد الكتالوج الصفحي، وسلوك فلاتر البحث. يجب تشغيل API smoke test أو تجربة التدفق يدويًا قبل العرض: تسجيل دخول، فتح الكتالوج، تغيير فلتر السعر، فتح التفاصيل، التسجيل، مراجعة **تسجيلاتي**، ثم تجربة مسار Admin/Instructor. تم التحقق أيضًا من التكامل الحقيقي مع API محلية معزولة: Health وCORS وJWT وتسجيل طالب وإنشاء كورس وبحث مفلتر وتسجيل وإلغاء وتدفقات Admin كلها نجحت.
