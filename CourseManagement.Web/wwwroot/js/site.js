document.addEventListener('DOMContentLoaded', () => {
    ...
    const revealTargets = document.querySelectorAll(
        '.page-heading, .stats-grid, .surface-card, .dashboard-card, .course-preview-card, .home-continue-panel, .related-courses-section, .instructor-profile-section'
    );
    if (!reduceMotion && 'IntersectionObserver' in window) {
        revealTargets.forEach((element) => element.classList.add('hf-reveal'));
